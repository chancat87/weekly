...
<small>The cover photo was taken on my way home on Valentine's Day. The clouds turned pink—a truly romantic touch from nature.</small>
...
A curated collection of tech blogs from major companies like Meta, Google, AWS, and Spotify. company blogs are often top-tier in quality—save this for your weekend reading.

**Web 3.0 Fundamentals**  
<https://j08v3n7cqq.feishu.cn/docs/doccnu8PLq5zJcaZJUzTaLyEOPc#Tb3wvI>  
A great primer on Web 3.0 concepts—covering identity, public chains, Layer 2, DeFi, and NFTs. perfect for someone looking for a high-level overview.
...
Beyond being a great plugin, the author has curated a massive list of high-quality websites, newsletters, and reading lists—perfect for staying up-to-date with first-hand news globally.
...
**Cognitive Bias Knowledge Handbook**  
<https://s75w5y7vut.feishu.cn/docs/doccn3BatnScBJe7wD7K3S5poFf>  
A fascinating list of 67 common cognitive biases covering decision-making, social interaction, and memory. Understanding these is incredibly helpful for building better user products.

**Job Opportunities for 2024 Graduates (Global)**  
<https://github.com/ReaVNaiL/New-Grad-2024>  
A GitHub repository aggregating global full-time roles in SWE, Quant, and PM for 2024 graduates. another reminder of why learning English is so important for engineers!
