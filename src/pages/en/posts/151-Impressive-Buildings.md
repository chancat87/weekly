...
<small>The cover photo shows a "tube building" (Tongzilaou) in Chongqing. I was curious why it was designed this way—it feels quite artistic and atmospheric.</small>
...
A short essay on "tool addiction." don't waste your days searching for the perfect note-taking app or the ultimate AI software. pick one that works and focus on finishing the actual work.

**Building an Exobrain: PKM in the AI Era**  
<https://www.indigox.me/build-exobrain/>  
An exploration of how to use new AI tools to extend the boundaries of thought and memory—creating a personal "Exobrain" for knowledge management.
...
A must-read for Mac app developers, covering changes in user habits and paid subscription trends.
