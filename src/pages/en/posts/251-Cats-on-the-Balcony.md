...
<small>The cover photo was taken on Saturday morning after sleeping until waking up naturally. The sun shone through the curtains, and I saw the shadow of Tangyuan the cat sunbathing on the cat tree on the balcony. It felt very atmospheric.</small>

> **Recording down-to-earth trending technologies seen every week, filtered and published here. If you like it, you can subscribe to this weekly via RSS to get update notifications.**

## Trending Tools

**Talk: Breakthrough and Development of New Generation Engineers**
<https://tw93.fun/2025-12-22/engineer.html>
This is a talk I gave last week at AICon Beijing titled "Breakthrough and Development of New Generation Engineers - Transformation Practice from Positions to Capabilities." I've converted the PPT into an article and posted it here, hoping to provide some input for the new generation of engineers. I look forward to everyone's exchange.
<img src="https://gw.alipayobjects.com/zos/k/engineer1/p1.png" width="800" />

**Mole reached 20K Stars! Thanks for your love for this release**
<https://github.com/tw93/Mole>
Mole, a tool that can clean up dozens of GBs at once, was born from the first line of code I wrote by the pool in Sanya during National Day. In less than 80 days, it went from 0 to 20K+ Stars, loved and recommended by developers worldwide. Thank you all for your support. Version 1.15 has been released with the following updates:

1. Startup and repeated scanning speeds increased by up to 10x, making daily use significantly faster.
2. Automatically skips network disks and adds timeout protection, making disk scanning more stable and less prone to lagging.
...
First, force restart your iPhone: Volume Up → Release, Volume Down → Release, then long-press the Power button until the Apple Logo appears. Wait a while after restarting and check—you'll find a few GBs are gone.
